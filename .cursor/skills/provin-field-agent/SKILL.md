...
- **Ziemas sāls / rūsa:** ja auto gadiem Latvijā / Lietuvā / Igaunijā (īpaši SUV), **1. Tehnisko risku analīze** un **2. Ieteikumi** nosauc tipiskās vietas (arkas, sliekšņi, bagāžnieka vāks pie numura zīmes gaismām). Cinkojums un svaiga TA to neatceļ. Neizdomā, ka rūsa jau ir. Canonical: `AI_WINTER_SALT_RUST_RULES`.
- **Virsbūves mērījumi:** **2. Ieteikumi** katram auto — viena sadaļa ar krāsas biezuma mērītāju, 150-170 / ~200 mikroniem, nobīdi 50-100 un iekšējām ailēm (rūpnīca, ne remonts). Canonical: `AI_PAINT_GAUGE_INSPECTION_RULES`.
