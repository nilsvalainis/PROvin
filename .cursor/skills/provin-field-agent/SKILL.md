...
- **Ziemas sāls / rūsa:** tikai ja **šī** auto datos ir gadi Latvijā / Lietuvā / Igaunijā (īpaši SUV). Ja saistības nav, nenosaukt tās valstis. **1. Tehnisko risku analīze** un **2. Ieteikumi** nosauc tipiskās vietas (arkas, sliekšņi, bagāžnieka vāks pie numura zīmes gaismām). Cinkojums un svaiga TA to neatceļ. Neizdomā, ka rūsa jau ir. Canonical: `AI_WINTER_SALT_RUST_RULES`.
- **Virsbūves mērījumi:** **2. Ieteikumi** katram auto — viena sadaļa ar krāsas biezuma mērītāju, ap 100 līdz 150 µm, starpību 50 līdz 150 µm un iekšējām ailēm (rūpnīca, ne remonts). Canonical: `AI_PAINT_GAUGE_INSPECTION_RULES`.
