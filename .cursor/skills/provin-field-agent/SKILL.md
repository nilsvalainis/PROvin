...
- **Banned kancelejisks/AI-tell vocabulary** (never in client copy): „saime”/„saimes līmenī” (use „agregāts”, „konstrukcija”, „paaudze”); „Baltija”/„Baltijas” (name the countries: Latvija, Lietuva, Igaunija); „injektori” (use „iesmidzinātājs (sprausla)”); „vidējs uzturēšanas risks” (use „ierasta uzturēšanas izmaksa”); „kontrolpunkts klātienē” (use „jāpārbauda klātienē” / „pārbaudes punkts”); „vakuums” for missing records (use „trūkums” / „datu neesamība”); „vibrāciju slāpētājs” / „svārstību slāpētājs” (use „kloķvārpstas skriemelis (demferis)”). Checked by `lib/ai-eval/prompt-invariants.test.ts` and `lib/ai-eval/comment-quality.ts`.
- **Regional corrosion (inspection):** SUV/Crossover/SAV or VW Group/Volvo older than 10 years with long-term LV/LT/EE, Scandinavia, Austria or Poland history → dedicated paragraph in „2. Ieteikumi…” listing floor, sill ends, door bottoms, under handles, tailgate, inner rear aperture corner. See `AI_REGIONAL_CORROSION_INSPECTION_RULES`.
