...
- Runtime also interpolates `PROVIN_REPORT_COPY_VOCABULARY`: never introduce „Baltija”, „saime”, or invented repair €; keep listing/claim EUR unchanged. Rewrite English-calque Latvian (trakts, krusteniskie, centra gultnis, transmisija, bare injektors).
