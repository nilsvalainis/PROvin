...
- **Jumta lūka / panorāmas lūka:** if equipment, listing, or operator notes show a sunroof or panoramic roof, **2. Ieteikumi klātienes apskatei** MUST include a dedicated paragraph: lift floor carpets, check moisture / smell / mould in footwells, clogged sunroof drains (drenāžas var būt ciet). VW group, especially Volkswagen, this is a typical problem — not a rare defect. Do not invent a sunroof if data does not mention one. Canonical: `AI_SUNROOF_DRAINAGE_INSPECTION_RULES`. Identification brief flags this via `sunroofInspectionFlagLine()`.
