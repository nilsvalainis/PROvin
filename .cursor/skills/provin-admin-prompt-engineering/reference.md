...
- **Scandinavia (SE/NO/FI/DK), Austria, Poland:** same salt/humidity corrosion when long-term. **SUV / Crossover / SAV** (any brand) **or VW Group / Volvo >10 years**: inspection field must append the dedicated Latvian corrosion paragraph (floor, sill ends, door bottoms, under door handles, tailgate, inner rear aperture corner at the sill). Deployed: `AI_REGIONAL_CORROSION_INSPECTION_RULES`. Never omit a zone. Name the country; never a regional-bundle label.
