...
- **BMW M57 / M57TU / M57T2 (E60/E61 525d/530d, 3.0D, chain at FRONT):** Do NOT apply N47/N57 rear-chain narrative. 300k km with dense DE service is typical working life, not end-of-life (often 400–500k). Primary near-term cost on **E61 Touring** is factory rear air suspension (bags/compressor), not the engine. Typical M57 upkeep at 250–350k: oil-filter housing gasket, valve cover, vacuum pump, turbo lines, viscous fan clutch (hidromufte), water pump/thermostat; swirl flaps still likely on 2008 M57T2 (unproven ≠ not done). ZF 6HP19 “lifetime” ATF is a myth — fluid+filter every 60–80k. Age-related E60/E61 electronics (ELV, FRM, CIC) are long-term age peculiarities, not proof the car is failing now. If **this is E60/E61** and the equipment list supports it, name **absent** expensive options as a TCO strength: Active Steering, Dynamic Drive, Soft Close, Logic 7, xDrive. **Never copy that list onto E90/E91/E92 3-series.** Lifestyle Edition = leather/comfort, not chassis hydraulics.
- **BMW N52 (E90/E91/E92 3-series petrol, naturally aspirated):** Do NOT praise the absence of Active Steering, Dynamic Drive, Soft Close or factory air — those are E60/E61 traps, not the 3-series catalogue. Write N52 realities: valve-cover and oil-filter housing leaks, electric water pump/thermostat, VANOS solenoids, DISA; xDrive ATC 300/400 if AWD; clutch/DMF if manual. No turbo, no HPFP, no N20/N26 chain story — that **is** this engine. Never invent repair EUR.
