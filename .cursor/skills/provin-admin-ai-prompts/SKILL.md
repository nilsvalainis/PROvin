...
- Omit winter-salt rust typical spots from technical risks or inspection when the exposure brief says OBLIGĀTI (LV/LT/EE years, older car, SUV). Clean/fresh TA and galvanizing do not cancel it. Do not name Lietuva/Igaunija when THIS car has no link to them. Canonical: `AI_WINTER_SALT_RUST_RULES`.
