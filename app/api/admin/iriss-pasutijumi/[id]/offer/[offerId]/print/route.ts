...
export async function GET(_req: Request, ctx: { params: Promise<{ id: string; offerId: string }> }) {
  ...
  const html = buildIrissOfferPrintHtml(rec, offer, dateFmt.format(new Date()));
