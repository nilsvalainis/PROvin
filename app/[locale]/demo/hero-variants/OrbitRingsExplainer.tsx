  ...
  return (
    <div className="demo-orbit-mini-lab border-t border-white/10 px-4 py-6 sm:px-6">
      ...
      <p className="mt-2 max-w-[42rem] text-[12px] leading-relaxed text-white/45">
        ...
        <code className="font-mono text-[11px] text-white/60">rotateY</code> (
        <code className="rounded bg-white/[0.06] px-1 font-mono text-[11px] text-white/60">hero-orbit-arm-spin-a</code> /{' '}
        <code className="rounded bg-white/[0.06] px-1 font-mono text-[11px] text-white/60">hero-orbit-arm-spin-b</code>
        ), disks ar <code className="font-mono text-[11px] text-white/60">rotateX</code> (slīpums) un iekšējam viegls{' '}
