  ...
  if (o.workspace && typeof o.workspace === "object") {
    ...
    try {
      json = JSON.stringify({
        ...
        tehniskoRiskuAnalize: typeof w.tehniskoRiskuAnalize === "string" ? w.tehniskoRiskuAnalize : "",
...
export async function patchOrderDraft(
  ...
  if (workspacePatch !== undefined && workspacePatch !== null) {
    ...
    const json = JSON.stringify({
      ...
      tehniskoRiskuAnalize: sanitizeDraftTextForStorage(workspacePatch.tehniskoRiskuAnalize),
