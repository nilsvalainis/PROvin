...
OBLIGĀTI:
- Identificē agregātu **iekšēji** (tilpums, jauda, degviela, izmešu klase, gads, dzinēja kods, kārba, piedziņa). IZVADĒ nesāc ar auto prezentāciju vai rindkopu „Agregātu identifikācija” — marka/motors/kārba jau ir citās sadaļās. Pirmā rindkopa = konkrēts risks (kas NAV dārgs / tuvākais rēķins), ar km un vecuma kalibrāciju tajā pašā rindkopā. Dzinēja/kārbas fakti tikai tad, kad tie izskaidro risku. Ja precīzs kods nav avotos — iekšēji turi 1–2 kandidātus; izvadē nosauc tos tikai pie attiecīgā riska, kā hipotēzi, ne kā reģistrā nolasītu faktu.
