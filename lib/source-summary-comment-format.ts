...
- **kW / VECUMA AIZSTĀJĒJS (kad koda NAV vai tas ir nepilnīgs):** tajā pašā markā un līdzīgā gadu joslā (±3–5 gadi) salīdzini **jaudu kW + tilpumu cm³ + degvielu**. Modeļi var atšķirties (V70 vs XC70 vs S80) — ja kW un tilpums sakrīt ar zināmu kodu joslu, iekšēji ņem to kodu kā 1. kandidātu un **meklē to**, nevis raksti vispārīgu „Volvo dīzelis”. Piemērs: Volvo ~136 kW + ~2400 cm³ dīzelis ~2005–2010 → D5244T11 klase (viens turbo), NE biturbo „melns vāks / bloka plaisa” stāsts. BMW ~145 kW + ~2993 cm³ dīzelis līdz ~2010 → M57 kandidāts, ne N57.
