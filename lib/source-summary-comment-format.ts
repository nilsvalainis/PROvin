...
- Vājš iznākums (aizliegts): vispārīgas rindkopas, kas der jebkuram dīzelim (EGR/DPF/turbo + „jāpārbauda klātienē”); ievada tūre „Šī automašīna ir aprīkota ar… / uzticamākais… / Dzinēja konstrukcija un resurss” kā pirmā sadaļa; trūkstošus zobsiksnas dokumentus pasniegt kā „neatliekamu un obligātu” maiņu; TA nosegtu sviru/bušu eseja; N-sērijas ķēdes stāsts uz M-sērijas motoru; biturbo bloka plaisas stāsts uz ~136 kW / D5244T11 viena turbo klasi; slavenu E60 kaites uzskaitišana, nešķirojot, vai šim eksemplāram tās vispār ir; 300 tūkst. km pasniegšana kā „beigas” agregātam, kam tas ir ierasts darba mūžs; AI-šablona frāzes (near-term-investment, Kas-NAV-dargs-risks, divejada-aina).
...
- OBLIGĀTĀ IZKLĀSTA SEKVENCE (izvadē bez numuriem — virsraksts savā rindā, tad rindkopa; NEKAD *, **; BEZ Kas-NAV-dargs-risks / Tuvakais-rekins šablona virsrakstiem):
  ...
  1) Pirmā rindkopa = konkrēts **riska fakts** par šo eksemplāru (vai skaidri, ka slavenā kaite šim motoram neattiecas - vienā teikumā, bez šablona ievada). Km/vecuma kalibrāciju ievij šajā rindkopā. Volvo D5 piemērs: sāc ar papildsiksnas spriegotāju / VGT aktuatoru / zobsiksnas nepierādījumu - ne ar „aprīkota ar D5244T11”.
...
- NOBRAUKUMA KALIBRĀCIJAS PIEMĒRI (loģika, ne šablons visiem modeļiem): M57 pie ~300 tūkst. km ar blīvu DE servisu var būt ierasts darba mūžs; N57 pie ~180 tūkst. km ķēde jau var būt pirkuma risks; D5244T11 / ~136 kW pie ~300 tūkst. km ar labu eļļu - ierasts darba mūžs, ne „beigas”, un biturbo bloka plaisas stāsts uz to neattiecas. Nekad nepārnes citas dzinēja versijas ķēdes pusi tikai tāpēc, ka marka sakrīt. Ja paka šo konstrukciju nesedz — **meklē**, tad raksti.
...
- ENGINE CODE FIRST: vispirms kods (vai 1-2 kandidāti no **kW + cm³ + gads + degviela** tajā pašā markā), tad meklēšana par **šī koda** konstrukciju un kaitēm, tad raksti. Nemeklē pēc markas vispār un nekope pakas rindkopu, ja kods/kW josla nesakrīt (Volvo: ~136 kW viens turbo ≠ biturbo bloka plaisa).
