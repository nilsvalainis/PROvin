...
const G: Record<SourceBlockKey, string> = {
  ...
  oneauto: NEUTRAL_AVOTU_HEADER_BG,
  cc_vin: NEUTRAL_AVOTU_HEADER_BG,
  asv: NEUTRAL_AVOTU_HEADER_BG,
  tjekbil: NEUTRAL_AVOTU_HEADER_BG,
  finnik: NEUTRAL_AVOTU_HEADER_BG,
  mnt_ee: NEUTRAL_AVOTU_HEADER_BG,
  lkf_ee: NEUTRAL_AVOTU_HEADER_BG,
  carinfo: NEUTRAL_AVOTU_HEADER_BG,
...
export const SOURCE_BLOCK_HEADER_TEXT_CLASS: Record<SourceBlockKey, string> = {
  ...
  oneauto: "text-slate-700",
  cc_vin: "text-slate-700",
  asv: "text-slate-700",
  tjekbil: "text-slate-700",
  finnik: "text-slate-700",
  mnt_ee: "text-slate-700",
  lkf_ee: "text-slate-700",
  carinfo: "text-slate-700",
  ltab: "text-slate-700",
...
export const SOURCE_BLOCK_BRAND_DOT: Record<SourceBlockKey, string> = {
  ...
  oneauto: "bg-indigo-700",
  cc_vin: "bg-violet-700",
  asv: "bg-blue-800",
  tjekbil: "bg-rose-600",
  finnik: "bg-orange-700",
  mnt_ee: "bg-cyan-600",
  lkf_ee: "bg-indigo-600",
  carinfo: "bg-teal-600",
  ltab: "bg-red-600",
  tirgus: "bg-sky-600",
