...
describe("csddFieldsFromStructuredAiPayload", () => {
  it("maps mileage, defects, and pamata dati", () => {
    const fields = csddFieldsFromStructuredAiPayload(
      {
        pamataDati: {
...
describe("mergeCsddTaAiIntoFields", () => {
  it("replaces empty TA history with second-pass rows", () => {
    const base = csddFieldsFromStructuredAiPayload(
      {
    ...
    const merged = mergeCsddTaAiIntoFields(base, {
      tehniskoApskasuVesture: [
        {
          datums: "16.12.2025",
