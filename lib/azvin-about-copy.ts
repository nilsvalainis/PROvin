...
const ABOUT_EN: AzvinAboutCopy = {
  ...
  bento: [
    ...
    { id: "europe", title: "Europe", body: "Registry and inspection depth." },
  ],
...
const ABOUT_AZ: AzvinAboutCopy = {
  ...
  bento: [
    ...
    { id: "europe", title: "Avropa", body: "Reyestr və texniki baxış." },
  ],
...
const ABOUT_RU: AzvinAboutCopy = {
  ...
  bento: [
    ...
    { id: "europe", title: "Европа", body: "Реестры и техосмотр." },
  ],
...
const ABOUT_LV: AzvinAboutCopy = {
  ...
  bento: [
    ...
    { id: "europe", title: "Eiropa", body: "Reģistri un tehniskā apskate." },
  ],
