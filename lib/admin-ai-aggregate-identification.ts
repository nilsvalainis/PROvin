...
Ar šiem parametriem nosaki visticamāko dzinēja konstrukciju / kodu (vai 1–2 kandidātus), ātrumkārbas tipu un piedziņu, tad kalibrē riskus pret šo nobraukuma un vecuma posmu. Ja precīza koda NAV: tajā pašā markā un līdzīgā gadu joslā (±3–5 gadi) ņem **kW + cm³ + degvielu** kā 1. kandidātu (modeļi var atšķirties) un meklē to - nevis „Volvo dīzelis vispār”. **Pirms rakstīšanas:** ja paka saka vienu (piem. viens turbo), bet šī auto kW/kods rāda citu (piem. D5244T11 = ~158 kW biturbo) - uzticies šī auto datiem + meklēšanai, ne pakai. Ja parametri pieļauj vairākas konstrukcijas ar būtiski atšķirīgu risku (piem. viens turbo pret biturbo), to pasaki un norādi, kā apstiprināt. Ja šis agregāts nav paketē — vispirms meklē Eiropas forumos / speciālistu rakstos, tad raksti.`;
}
