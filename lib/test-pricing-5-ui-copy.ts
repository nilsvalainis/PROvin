...
const TP5_UI_COPY_LV: Tp5UiCopy = {
  ...
  vinPlaceholder: "Ievadi VIN vai numurzīmi",
  vinAria: "Ievadi VIN kodu vai valsts numurzīmi",
  listingPlaceholder: "Iekopē sludinājuma linku (nav obligāti)",
  listingAria: "Iekopē sludinājuma linku (nav obligāti)",
...
const TP5_UI_COPY_EN: Tp5UiCopy = {
  ...
  vinPlaceholder: "Enter VIN or plate number",
  vinAria: "Enter a VIN code or licence plate number",
  listingPlaceholder: "Paste the listing link (optional)",
  listingAria: "Paste the listing link (optional)",
