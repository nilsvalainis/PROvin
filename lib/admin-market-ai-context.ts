...
/** ss.lv + IRISS EU izsoles + Outvin + admin tirgus lauki — AI tirgus/cenu analīzei. */
export async function buildMarketAnalysisAiContext(opts: {
  ...
  if (url) {
    ...
    parts.push(formatListingAiSnapshotForAi(listingSnapshot));
  }
