...
export function WhatsAppFab() {
  ...
  return (
    <a
      ...
      className="whatsapp-fab fixed bottom-[max(1rem,env(safe-area-inset-bottom,0px))] right-[max(1rem,env(safe-area-inset-right,0px))] z-[90] inline-flex h-14 w-14 touch-manipulation items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_0_0_1px_rgba(0,0,0,0.08),0_10px_26px_rgba(37,211,102,0.35)] transition-transform hover:scale-[1.04] active:scale-95 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#25D366]"
    >
