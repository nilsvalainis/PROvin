...
export function WhatsAppFab() {
  ...
  /** Mājas hero: mobilajā — virs četru pīlāru rindas; citur / desktop — apakšējā stūris. */
  const className = [
    ...
    isHome
      ? "max-md:bottom-[calc(env(safe-area-inset-bottom,0px)+10.75rem)] md:bottom-[max(1.25rem,env(safe-area-inset-bottom,0px))]"
