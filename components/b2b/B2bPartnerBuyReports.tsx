...
function useIsDesktopBuy(): boolean {
  return useSyncExternalStore(subscribeLg, lgSnapshot, () => false);
}
    ...
    mounted && open && desktop
      ? createPortal(
          <div className="fixed inset-0 z-[120]">
            ...
            <aside
              id={panelId}
              className="absolute inset-y-0 right-0 flex w-full max-w-[42rem] flex-col overflow-y-auto border-l border-white/14 bg-[#0c0c0c] px-5 py-5 shadow-[-24px_0_48px_rgb(0_0_0_/_0.45)]"
              role="dialog"
              aria-modal="true"
