...
export function DemoPathThemeToggle() {
  ...
  const shell =
    theme === "dark"
      ...
      : "border-black/[0.08] bg-white/95 text-[#1d1d1f] shadow-[0_6px_22px_rgba(0,0,0,0.12)] backdrop-blur-md focus-visible:ring-[rgb(0_102_255/0.35)] focus-visible:ring-offset-white";
