...
export function IrissNewOfferMenuButton({ compact = false }: Props) {
  ...
  return (
    <button
      ...
      className={
        compact
          ? "inline-flex min-h-[38px] items-center gap-1.5 rounded-lg border border-black bg-transparent px-3 py-1.5 text-[12px] font-semibold uppercase tracking-[0.06em] text-black transition hover:bg-black/5 disabled:opacity-60"
          : "inline-flex min-h-[38px] items-center gap-1.5 rounded-lg border border-black bg-transparent px-3 py-1.5 text-[12px] font-semibold uppercase tracking-[0.06em] text-black transition hover:bg-black/5 disabled:opacity-60"
      }
