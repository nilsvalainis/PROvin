...
export function AdminShell({ children, baseUrl, notice, workspace = "pro" }: Props) {
  ...
  return (
    <div className="flex min-h-dvh flex-col bg-white">
      <header className="sticky top-0 z-[45] flex shrink-0 items-center gap-2 border-b border-zinc-700/80 bg-zinc-800 px-3 py-2 shadow-sm sm:px-4">
        ...
        <div className="flex shrink-0 items-center gap-1.5 md:hidden">
          <button
            ...
            className="inline-flex min-h-10 min-w-10 shrink-0 items-center justify-center rounded-xl bg-transparent p-1.5 text-white shadow-sm outline-none transition hover:bg-white/10 focus-visible:ring-2 focus-visible:ring-white/30 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-800"
          ...
          <button
            ...
            className="inline-flex min-h-10 min-w-10 shrink-0 items-center justify-center rounded-xl bg-transparent p-1.5 text-white shadow-sm outline-none transition hover:bg-white/10 focus-visible:ring-2 focus-visible:ring-white/35 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-800"
