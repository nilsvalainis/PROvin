...
function navItemClass(active: boolean) {
  if (active) {
    return "inline-flex min-h-[38px] items-center rounded-lg bg-white/10 px-3 py-1.5 text-[12px] font-semibold uppercase tracking-[0.06em] text-white";
  }
  return "inline-flex min-h-[38px] items-center rounded-lg bg-transparent px-3 py-1.5 text-[12px] font-semibold uppercase tracking-[0.06em] text-white transition hover:bg-white/10";
}
