...
const DEFAULT_SERVICE =
  "Komisijas pakalpojumi februārī. Afilio numurs: 0220725002, konts: nils.valainis@gmail.com";
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-8 sm:px-6">
      ...
      <p className="mt-2 text-sm leading-relaxed text-[var(--color-provin-muted)]">
        Rēķins bez PROVIN zīmola — tikai tabulas un tavi iebūvētie piegādātāja rekvizīti. Lauki „Pakalpojuma
        apraksts” un „Summa” ir brīvi labojami. Marta rēķinam ieraksti nākamo numuru (piem. PKD-2026-004) un
        atbilstošo aprakstu.
      </p>
