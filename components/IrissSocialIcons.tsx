...
export function getIrissSocialUrls() {
  return {
    tiktok: process.env.NEXT_PUBLIC_IRISS_TIKTOK_URL?.trim() || IRISS_SOCIAL_DEFAULTS.tiktok,
    youtube: process.env.NEXT_PUBLIC_IRISS_YOUTUBE_URL?.trim() || IRISS_SOCIAL_DEFAULTS.youtube,
    instagram: process.env.NEXT_PUBLIC_IRISS_INSTAGRAM_URL?.trim() || IRISS_SOCIAL_DEFAULTS.instagram,
  };
}

export function IrissSocialIcons({
  tiktok,
  youtube,
  instagram,
  socialLabel,
