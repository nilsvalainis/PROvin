            ...
            {step === 1 && !hideStepOneCta ? (
              <div className="flex w-full justify-center">
                <button
                  type="button"
                  onClick={goToStepTwo}
                  className="provin-home-pill-cta provin-home-pill-cta--wide z-10 mt-1 flex min-h-[52px] w-full max-w-[min(100%,416px)] touch-manipulation items-center justify-center whitespace-normal text-balance text-center text-[clamp(10px,2.95vw,11px)] font-medium leading-snug tracking-[0.12em] shadow-[0_5px_17px_rgba(0,0,0,0.13)] active:scale-95"
                >
                  {t("heroOrderCta")}
                </button>
              </div>
                ...
                !hideStepOneCta ? (
                  <div className="flex w-full justify-center">
                    <button
                      type="button"
                      onClick={goToStepTwo}
                      className="provin-home-pill-cta provin-home-pill-cta--wide z-10 flex min-h-[50px] w-full max-w-[min(100%,416px)] touch-manipulation items-center justify-center whitespace-normal text-balance text-center shadow-[0_5px_17px_rgba(0,0,0,0.13)] active:scale-95"
                    >
                      {t("heroOrderCta")}
                    </button>
                  </div>
