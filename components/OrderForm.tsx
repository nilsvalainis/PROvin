...
const inputHero =
  "relative z-10 mt-1.5 box-border min-h-11 w-full rounded-none border-0 border-b border-[#050505] bg-transparent px-0 py-2.5 text-[15px] font-normal text-[#050505] outline-none transition-colors placeholder:text-[#050505] focus:border-[#050505] focus:shadow-none focus:ring-0 sm:min-h-0 sm:text-[16px]";
...
export function OrderForm({ className, variant = "default" }: OrderFormProps) {
  ...
  const hintClass = hero
    ? "mt-1.5 text-[11px] font-normal leading-snug text-[#050505]/70"
    : "mt-1 text-[11px] font-normal leading-snug text-[#86868b]";

  const optionalMutedClass = hero ? "text-[#050505]/70" : "text-[#aeaeb2]";
    ...
    <form onSubmit={onSubmit} className={formShell} noValidate>
      <div className={`grid sm:grid-cols-2 ${gridGap}`}>
        ...
        <div className="sm:col-span-2">
          ...
          <p
            className={
              hero ? "mt-1.5 text-[11px] font-normal text-[#050505]/70" : "mt-1 text-[11px] font-normal text-[#aeaeb2]"
            }
          >
            {t("vinHint")}
          </p>
        ...
        {hero ? (
          <>
            ...
            >
              ...
              <p className="mt-2 text-[11px] font-normal leading-snug text-[#050505]/70 sm:text-[12px]">
                {t("summaryNote")}
              </p>
            </div>
            <label
            ...
            <button
              ...
              className="provin-btn provin-btn--compact home-cta-blueprint mx-auto flex min-h-12 w-full max-w-[min(100%,20rem)] items-center justify-center gap-2.5 rounded-[2px] px-7 py-3.5 text-center text-[15px] font-bold text-white ring-0 shadow-none disabled:opacity-60 sm:min-h-[50px]"
            >
              {loading ? (
                t("payLoading")
              ) : (
            ...
            <p className="text-center text-[10px] font-normal leading-relaxed text-[#050505]/70 sm:text-[11px]">
              {t("stripeNote")}
            </p>
          </>
        ) : (
      ...
      {error && (
        <p
          className={
            hero
              ? "mt-5 rounded-[2px] border border-[#050505]/20 bg-red-50 px-4 py-3 text-center text-[13px] font-normal text-red-900"
