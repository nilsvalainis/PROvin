type OrbitRingsExplainerProps = {
  /** Apvienotajā `/demo` studijā — enkurs sānu joslas saitēm. */
  domId?: string;
};
 ...
 */
export function OrbitRingsExplainer({ domId }: OrbitRingsExplainerProps) {
  return (
    <div
      id={domId}
    ...
    >
      ...
      <p className="mt-2 max-w-[42rem] text-[12px] leading-relaxed text-white/45">
        ...
        <code className="font-mono text-[11px] text-white/60">left: 50%</code> /{" "}
        <code className="font-mono text-[11px] text-white/60">top: 50%</code> un{" "}
