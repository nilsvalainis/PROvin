...
import { OrbitRingsExplainer } from "@/components/demo/OrbitRingsExplainer";
...
export function HeroVariantsStudioSection({ layout }: HeroVariantsStudioSectionProps) {
  const embedded = layout === "embedded";
  const orbitMiniId = embedded ? "demo-studio-orbit-mini" : undefined;
  ...
  return (
    <>
      ...
      <OrbitRingsExplainer domId={orbitMiniId} />
    </>
  );
}
