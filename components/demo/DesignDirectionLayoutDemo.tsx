 ...
 */
export function DesignDirectionLayoutDemo() {
  return (
    <div className="demo-design-dir min-w-0 pb-24 pt-6 text-white sm:pt-10">
      <section className="demo-design-dir__section demo-design-dir__section--band-a pb-20 pt-4 sm:pb-28 sm:pt-8" id="demo-design-hero">
        <div className="demo-design-dir__shell relative text-center">
          ...
          <h1 className="demo-design-dir__title relative z-[1] mt-4 max-w-[40rem] mx-auto">
      ...
      <section className="demo-design-dir__section demo-design-dir__section--band-b py-16 sm:py-20" id="demo-design-axis">
        <div className="demo-design-dir__shell">
          ...
          <p className="demo-design-dir__body mt-3 max-w-[40rem]">
            Visi bloki zemāk ir iekš `demo-design-dir__shell` — tas ir vizuālais priekšstats par vienu satura kolonnu
            ar vienādu horizontālo nobīdi visā garumā.
          </p>
      ...
      <section className="demo-design-dir__section demo-design-dir__section--band-c py-16 sm:py-20" id="demo-design-signals">
        <div className="demo-design-dir__shell">
      ...
      <section className="demo-design-dir__section demo-design-dir__section--band-a py-16 sm:py-20" id="demo-design-grid">
        <div className="demo-design-dir__shell">
      ...
      <section className="demo-design-dir__section demo-design-dir__section--band-b py-16 sm:py-20" id="demo-design-editorial">
        <div className="demo-design-dir__shell">
      ...
      <section className="demo-design-dir__section demo-design-dir__section--band-c py-16 sm:py-20" id="demo-design-faq">
        <div className="demo-design-dir__shell">
      ...
      <section className="demo-design-dir__section border-t border-white/[0.06] py-14" id="demo-design-outro">
