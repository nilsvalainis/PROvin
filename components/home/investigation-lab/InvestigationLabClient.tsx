...
const GLASS =
  "rounded-2xl backdrop-blur-2xl bg-white/[0.03] border border-white/[0.08] shadow-2xl";
...
export function InvestigationLabClient({
  ...
  return (
    <section
      ...
      className="home-body-ink relative overflow-hidden bg-transparent px-4 py-16 sm:px-6 sm:py-20 lg:py-28"
    >
      <div className="relative mx-auto grid max-w-[1200px] gap-12 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)] lg:gap-16 lg:gap-x-14">
        ...
        <div className="flex flex-col gap-6 lg:gap-8">
          {pillars.map((p, i) => {
            ...
            return (
              <div key={`${p.title}-${i}`} className={`${GLASS} p-6 sm:p-8`}>
