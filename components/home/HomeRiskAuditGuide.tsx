              ...
              <div className="lg:col-span-7">
                {success ? (
                  ...
                  <>
                    <form
                      onSubmit={submitFree}
                      className="space-y-4 rounded-2xl border border-[#0066ff]/35 bg-[#0066ff]/[0.07] px-5 py-5 shadow-[0_20px_52px_rgb(0_0_0/0.28)] sm:px-6 sm:py-6"
                    >
                      <p className="text-[13px] text-white/55">{t("form.boundary")}</p>
                      <div>
                        <label
                    ...
                    <div className="mt-5 flex flex-col gap-2 border-t border-white/[0.08] pt-5 sm:flex-row sm:items-center sm:gap-4">
                      <LiquidLink
                        href={homeHeroCheckoutHref("audits")}
                        onClick={() => safeTrack("risk_guide_audits_clicked")}
                      >
                      ...
                      <Link
                        href={homeHeroCheckoutHref("mini")}
                        onClick={() => safeTrack("risk_guide_mini_clicked")}
                        className="inline-flex min-h-[44px] items-center justify-center px-2 text-[12px] font-semibold uppercase tracking-[0.1em] text-white/40 transition hover:text-white/70"
                      >
                        {t("step2.miniSoft")}
                      </Link>
                    </div>
